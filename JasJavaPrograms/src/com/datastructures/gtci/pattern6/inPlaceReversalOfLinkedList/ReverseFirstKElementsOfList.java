...
public class ReverseFirstKElementsOfList {
    ...
    Output = 3 -> 2 -> 1 -> 4 ->  5
    */
    // Q:2 works fine below with some tweaks in the logic of Q1. Still discuss to compare my solution vs theirs
...
//        Alternate Question : Reverse the first ‘k’ elements of a given LinkedList -- WORKS
        ListNode result = ReverseFirstKElementsOfList.reverse(head, 1, 4);
