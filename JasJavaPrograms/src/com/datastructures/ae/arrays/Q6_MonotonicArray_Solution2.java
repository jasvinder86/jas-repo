...
public class Q6_MonotonicArray_Solution2 {

    public static void main(String[] args) {
        System.out.println(Q6_MonotonicArray_Solution2.isMonotonic(new int[]{-1, -5, -10, -1100, -1100, -1101, -1102, -9001}));
        System.out.println(Q6_MonotonicArray_Solution2.isMonotonic(new int[]{1, 5, -10, 1100, -1100, 1101, -1102, 9001}));
        System.out.println(Q6_MonotonicArray_Solution2.isMonotonic(new int[]{1, 5, 10, 1100, 1100, 1101, 1102, 9001}));
        System.out.println(Q6_MonotonicArray_Solution2.isMonotonic(new int[]{1}));
        System.out.println(Q6_MonotonicArray_Solution2.isMonotonic(new int[]{}));
